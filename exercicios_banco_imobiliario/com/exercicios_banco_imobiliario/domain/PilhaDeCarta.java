...
public class PilhaDeCarta {
	...
	public void criaPilhaDeCartas() {
		...
		cartas.add(carta0);
		Carta carta1 = new TituloDePropriedade(1, "Leblon", 100, 6, 30, 90, 270, 400, 500, 50, 50, "vermelhoFraco");
		cartas.add(carta1);
		Carta carta2 = new CartaSorteReves(2, "Sorte ou Reves");
		cartas.add(carta2);
		Carta carta3 = new TituloDePropriedade(3, "Av. Presidente Vargas", 60, 2, 10, 30, 90, 160, 250, 30, 50, "vermelhoFraco");
		cartas.add(carta3);
		Carta carta4 = new TituloDePropriedade(4, "Av. Nossa Senhora de Copacabana", 60, 2, 10, 30, 90, 160, 250, 30, 50, "vermelhoFraco");
		cartas.add(carta4);
		Carta carta5 = new Companhia(5, "Cia Ferrovi�ria", 200, 100, 50);
		cartas.add(carta5);
		Carta carta6 = new TituloDePropriedade(6, "Av. Brigadeiro Faria Lima", 240, 20, 100, 300, 750, 925, 1100, 120, 150, "azulCeu");
		cartas.add(carta6);
		Carta carta7 = new Companhia(7, "Cia de Via��o", 200, 100, 50);
		cartas.add(carta7);
		Carta carta8 = new TituloDePropriedade(8, "Av. Rebou�as", 220, 18, 90, 250, 700, 875, 1050, 110, 150, "azulCeu");
		cartas.add(carta8);
		Carta carta9 = new TituloDePropriedade(9, "Av. 9 de Julho", 220, 18, 90, 250, 700, 875, 1050, 110, 150, "azulCeu");
		cartas.add(carta9);
		Carta casa10 = new CartaEspecial(10, "Pris�o (visitante)");
		cartas.add(casa10);
		Carta carta11 = new TituloDePropriedade(11, "Av. Europa", 200, 16, 80, 220, 600, 800, 1000, 100, 100, "violeta");
		cartas.add(carta11);
		Carta casa12 = new CartaSorteReves(12, "Sorte ou Reves");
		cartas.add(casa12);
		Carta carta13 = new TituloDePropriedade(13, "Rua Augusta", 180, 14, 70, 200, 550, 750, 950, 90, 100, "violeta");
		cartas.add(carta13);
		Carta carta14 = new TituloDePropriedade(14, "Av. Pacaembu", 180, 14, 70, 200, 550, 750, 950, 90, 100, "violeta");
		cartas.add(carta14);
		Carta carta15 = new Companhia(15, "Cia de T�xi", 150, 75, 40);
		cartas.add(carta15);
		...
		cartas.add(carta20);
		Carta carta21 = new TituloDePropriedade(21, "Flamengo", 120, 8, 40, 100, 300, 450, 600, 60, 50, "vermelhoForte");
		cartas.add(carta21);
		Carta carta22 = new CartaSorteReves(22, "Sorte ou Reves");
		cartas.add(carta22);
		Carta carta23 = new TituloDePropriedade(23, "Botafogo", 100, 6, 30, 90, 270, 400, 500, 50, 50, "vermelhoForte");
		cartas.add(carta23);
		Carta carta24 = new CartaEspecial(24, "Imposto de Renda");
		cartas.add(carta24);
		Carta carta25 = new Companhia(25, "Cia de Navega��o", 150, 75, 40);
		cartas.add(carta25);
		...
		cartas.add(carta29);
		Carta carta30 = new CartaEspecial(30, "V� para a Pris�o");
		cartas.add(carta30);
		Carta carta31 = new TituloDePropriedade(31, "Copacabana", 260, 22, 110, 330, 800, 975, 1150, 130, 150, "verde");
		cartas.add(carta31);
		Carta carta32 = new Companhia(32, "Cia de Avia��o", 200, 100, 50);
		cartas.add(carta32);
		Carta carta33 = new TituloDePropriedade(33, "Av. Vieira Souto", 320, 28, 150, 450, 1000, 1200, 1400, 160, 200, "verde");
		cartas.add(carta33);
		Carta carta34 = new TituloDePropriedade(34, "Av. Atl�ntica", 300, 26, 130, 390, 900, 1100, 1275, 150, 200, "verde");
		cartas.add(carta34);
		Carta carta35 = new Companhia(35, "Cia de T�xi A�reo", 200, 100, 50);
		cartas.add(carta35);
		...
		cartas.add(carta37);
		Carta carta38 = new TituloDePropriedade(38, "Jardim Paulista", 280, 24, 120, 360, 850, 1025, 1200, 140, 150, "azulEscuro");
		cartas.add(carta38);
		Carta carta39 = new TituloDePropriedade(39, "Brooklin", 260, 22, 110, 330, 800, 975, 1150, 130, 150, "azulEscuro");
		cartas.add(carta39);
